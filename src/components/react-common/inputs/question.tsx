...
} from "answerwriting/components/dashboard/tools/answer-evaluater/tooltips/upload-question-tooltip";
export const QuestionInput = ({
  ...
  looks = {
    ...
    skipQuestionLabel: "Question already present in the answer image ?",
    questionTextLabel: "Question",
    questionPlaceHolder: "Type your question here...",
    skipQuestionUploadToolTip: <SkipQuestionUploadToolTip />,
    uploadQuestionImageToolTip: <UploadQuestionToolTip />,
  },
}: {
  looks?: {
    mainHeading: string;
    ...
    skipQuestionUploadToolTip: React.ReactElement;
    uploadQuestionImageToolTip: React.ReactElement;
    ...
    <>
      ...
      <Card className="shadow-sm">
        <CardHeader>
          ...
          <CardDescription>{looks.mainDescription}</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="flex items-center space-x-2 mb-4">
            ...
            <div className="flex gap-1">
              <Label htmlFor="question-in-answer" className="leading-1">
                {looks.skipQuestionLabel}
              </Label>
              {looks.skipQuestionUploadToolTip}
            </div>
          </div>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <Label htmlFor="question">
                        {looks.questionTextLabel}
                      </Label>
                      <FormControl>
                        <Textarea
                          id="question"
                          placeholder={looks.questionPlaceHolder}
                  ...
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex gap-1">
                      <h3 className="font-semibold">
                        {`Question too lengthy ?`}
                      </h3>
                      {looks.uploadQuestionImageToolTip}
                    </div>
