...
export const SectionFour = () => {
  return (
    <div className="flex flex-col items-center max-w-5xl mx-auto px-4 py-16 md:py-0 md:px-10 lg:px-16">
      {/** Section 1 */}
      <div className="flex flex-col-reverse md:flex-row items-center gap-8">
        <div className="w-full md:w-1/2 flex flex-col justify-center space-y-4 text-center md:text-left">
          ...
          <p className="text-lg text-secondary-dark">
            Refine your writing with each evaluation. Our AI-driven feedback helps you
            improve clarity, structure, and relevance—ensuring you get better with every try.
          </p>
        </div>
      ...
      <div className="flex flex-col-reverse md:flex-row items-center gap-8">
        <div className="w-full md:w-1/2 flex flex-col justify-center space-y-4 text-center md:text-left">
          ...
          <p className="text-lg text-secondary-dark">
            Stop second-guessing your writing. With AI-driven evaluation, ensure every answer 
            is well-structured, relevant, and effective. We refine your responses, highlight 
            improvements, and help you write with confidence.
          </p>
        </div>
        <div className="w-full md:w-1/2 flex justify-center">
          <Image
