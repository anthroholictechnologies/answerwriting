    ...
    <Container>
      <>
        ...
        <div className="flex flex-col gap-6 text-left">
          <p>
            Welcome to <strong>AnswerWriting.com</strong> – your go-to platform
            for mastering the art of answer writing!
          </p>

          <p>
            We understand that <strong>answer writing</strong> is the key to
            success in competitive exams like <strong>UPSC Mains</strong>, where
            structured, well-articulated responses can make all the difference.
            However, getting consistent feedback and improving without a mentor
            can be a challenge. That’s where AnswerWriting.com steps in!
          </p>

          <h2 className="text-xl font-semibold mt-4">What We Offer</h2>
          <ul className="list-disc pl-6">
            <li>
              AI-powered evaluation to provide instant feedback on your answers.
            </li>
            <li>
              Submit handwritten answers and refine your structure, clarity, and
              presentation.
            </li>
            <li>
          ...
          <p>
            ...
            <strong>smart feedback</strong> can transform an average answer into
            a high-scoring one. Our mission is to empower aspirants with the
            right tools to write better, faster, and more effectively.
          </p>
          ...
          <p>
            ...
            , a trusted name among <strong>UPSC Anthropology optional</strong>{" "}
            aspirants. We are dedicated to bringing{" "}
