        ...
        <div className="flex flex-col gap-8">
          <div>
            ...
            <p>
              ...
              answer writing skills through AI-powered evaluation. Your privacy
          ...
          <div>
            ...
            <ul className="list-disc ml-5">
              ...
              <li>
                <strong>User-Generated Content:</strong> Handwritten answers and
                text-based submissions for AI evaluation.
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="list-disc ml-5">
              ...
              <li>
                Communicate updates, notifications, and promotional offers (only
                if you opt-in).
              </li>
