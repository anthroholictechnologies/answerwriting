      ...
      <>
        ...
        <div className="flex flex-col gap-8">
          ...
          <div>
            ...
            <ul className="list-disc pl-6">
              <li>
                <strong>Ownership:</strong> All content, AI-generated feedback,
                and materials on AnswerWriting.com are the intellectual property
                of Anthroholic Technologies Private Limited.
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="list-disc pl-6">
              ...
              <li>
                <strong>No Refund Policy:</strong> Refunds are applicable as per
                the refund policy.{" "}
                <Link
          ...
          <div>
            ...
            <ul className="list-disc pl-6">
              ...
              <li>
                Sharing or distributing AI-generated feedback for commercial use
          ...
          <div>
            ...
            <p>
              We strive to provide accurate and reliable AI-driven feedback, but
              we do not guarantee any specific improvements in exam performance.
            </p>
            <p>
