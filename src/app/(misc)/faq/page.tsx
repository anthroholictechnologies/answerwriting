        ...
        <div className="flex flex-col gap-8">
          <div>
            ...
            <ol className="flex flex-col gap-4 list-decimal ml-5">
              <li>
                ...
                relevance, clarity, and presentation, helping aspirants improve
                their answer-writing skills.
              </li>
              <li>
                <strong>How does AnswerWriting.com work?</strong> <br />
                You upload a PDF or image of your handwritten answer, and our AI
                analyzes it based on key UPSC evaluation criteria. It provides
                structured feedback, highlights areas for improvement, and helps
                refine your writing.
              </li>
              <li>
                <strong>Is AnswerWriting.com free to use?</strong> <br />
                Yes, we offer a free version with essential evaluation features.
                However, premium plans unlock unlimited evaluations, human
                feedback, and in-depth feedback.
              </li>
              <li>
                <strong>Can AnswerWriting.com replace human evaluators?</strong>{" "}
                <br />
          ...
          <div>
            ...
            <ol className="flex flex-col gap-4 list-decimal ml-5">
              ...
              <li>
                <strong>Does AnswerWriting check grammar and spelling?</strong>{" "}
                <br />
                Since UPSC Mains is handwritten, grammar and spelling checks are
                not a primary focus. However, we provide feedback on clarity,
          ...
          <div>
            ...
            <ol className="flex flex-col gap-4 list-decimal ml-5">
              <li>
                ...
                <br />
                You can either upload a clear image or a PDF of your handwritten
                answer for evaluation.
              </li>
              <li>
                <strong>Does the platform support all subjects?</strong> <br />
