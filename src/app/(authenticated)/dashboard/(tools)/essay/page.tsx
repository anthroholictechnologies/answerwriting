...
import { Marks } from "answerwriting/types/ai.types";
...
import EssayEvaluatorForm from "answerwriting/components/dashboard/tools/essay-evaluator/form-essay-evaluator";
...
export default function EssayEvalTool() {
      ...
      try {
        ...
        if (result.success) {
          ...
          if (result.errorCode === ErrorCodes.UNAUTHORIZED) {
            ...
            toast.error({
              title: "Unable to Essay  Topic/Question",
            ...
            toast.error({
              ...
              description:
                "Please Upgrade to PRO to continue evaluating your Essays.",
              action: (
                <ToastAction
                  altText="Try again"
        ...
        toast.error({
          ...
          description: "There was a problem in evaluating your Essay.",
          action: (
            <ToastAction
              altText="Try again"
              className="px-2 md:px-4 py-2 bg-white/10 hover:bg-white/20 text-white rounded-lg border border-white/20 hover:border-white/30 transition-all backdrop-blur-sm font-medium text-sm"
